    ...
    <div className="phone-shell">
      <div className="studylens-card">
        <div className="topbar">
          <div className="brand">        
            {/* <img className="QUT_RGB" src={qutLogo} alt="" />     */}
            <h1>StudyLens</h1>
          </div>
        ...
        <div className='unit-card-urgent'>
          ...
          <div className='urgent-due1'>
            <span className='urgent-due'>Due {mostUrgent.dueDateFormatted} · {mostUrgent.pointsPossible}pts</span>
          </div>
...
function UnitCard({ unit, onClick }) {
  ...
  return (
    <div className='unit-card' onClick={onClick}>
      ...
      <div
        className={`progress-fill ${status === 'danger' ? 'red' : 'green'}`}
        style={{ width: `${grade ?? 0}%` }}></div>
      </div>

      <div className='unit-card-bottom'>
        <span className='unit-grade'> Current Grade : {grade !== null ? `${grade}%` : 'No grades yet'}
        </span>
